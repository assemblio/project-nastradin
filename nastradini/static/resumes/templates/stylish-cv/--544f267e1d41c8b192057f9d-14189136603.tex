...
Prishtina\\ % Your mailing address
{\Large\Letter} @mail.com \ {\Large\Telefon} (000) 111-1111 % Your email address and phone number
}
...
{\addfontfeature{LetterSpace=20.0}\fontsize{36}{36}\selectfont\scshape  } % Your name at the top
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{2011 --- 2012}\\
\gray Degree & \textbf{Masters of Commerce}\\
\gray University & \textbf{The University of California} \hfill Berkley\\
...
\gray Degree & \textbf{Bachelor of Business Studies}\\
\gray University & \textbf{NThe University of California} \hfill Berkley\\
%& Extra information about degree
\end{tabularx}
